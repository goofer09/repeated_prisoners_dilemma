...
from stochastic_noise_scratch import apply_noise_pair
import numpy as np
...
def rollout_episode(env,policy1,policy2,horizon,epsilon=0.0,rng=None):
    ...
    for t in range(horizon):
        ...
        a1,a2,flip1,flip2=apply_noise_pair(a1_intended,a2_intended,epsilon,rng)
...
if __name__ == "__main__":
    traj, summary = rollout_episode(RepeatedPrisonersDilemmaEnv(), TitForTat(), AlwaysD(), horizon=10)
